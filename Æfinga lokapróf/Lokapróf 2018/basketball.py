...
class BasketballPlayer():
    ...
    def __str__(self,team):
        return 'Scoring:\nNumber: {} Points: {}'.format(team , self.points)
...
def print_winner(team_a, team_b):
    ...
    if team_a.get_points() > team_b.get_points():
        return '{} Won!'.format(team_a)
    elif team_b.get_points() > team_a.get_points():
        return '{} Won!'.format(team_b)
    else:
        return 'Tie!'
...
def print_scores(team_a, team_b):
    ...
    return '{} scored {} points!\n{} scored {} points!'.format(team_a, team_a.get_points(), team_b, team_b.get_points())
